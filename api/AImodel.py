...
#Using Pandas to get data from excel file
    dataframe = pd.ExcelFile(cd + "\\api\\sickleaveData.xlsx")
...
model = MLPClassifier(solver='lbfgs', alpha=1e-5, hidden_layer_sizes=(5, 2), random_state=1) # https://scikit-learn.org/stable/modules/neural_networks_supervised.html
#model = GaussianNB()
#model = Perceptron(tol=1e-5, random_state=0)
print("X: ", len(training_X))
print("Y: ", len(training_Y))
