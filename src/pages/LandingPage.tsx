      ...
      <Content>
        ...
        >
          ...
          <p className="w-3/4 mt-8 text-left">
            In order to provide you with appropriate support during your sick
            leave, we will make a prediction of its duration based on your data.
            This is helpful in planning for support measures such as follow-up
            meetings and economical support for a longer period of time.
          </p>
        </div>
        ...
        <div className="text-center bg-slate-50 flex justify-center">
          ...
          >
            ...
            <p className="py-3 text-left w-4/6">
              Below is all the information about you that will be used in
              predicting your sick leave duration. This information is gathered
              from the national population register and our registers.
            </p>
            <p className="py-3 text-left mb-4 w-4/6">
              Click on the &quot;?&quot; beside each data point to see why it is
              used.
            </p>
